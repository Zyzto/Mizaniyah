...
import '../../banks/widgets/sms_pattern_tester.dart';
...
class SmsPatternsTab extends ConsumerStatefulWidget {
  const SmsPatternsTab({super.key});

  @override
  ConsumerState<SmsPatternsTab> createState() => _SmsPatternsTabState();
}

class _SmsPatternsTabState extends ConsumerState<SmsPatternsTab>
  ...
  void initState() {
    ...
    // On iOS: Patterns and Notifications only (2 tabs)
    // On Android: Patterns, SMS, and Notifications (3 tabs)
